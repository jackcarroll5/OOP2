...
public class MyFlicks {
    public static void main(String[] args) {
        ...
        Film film1 = new Film("No Title","No Director",0);
        ...
        for (int i = 0; i < catalog.length; i++)
        {
           ...
           film3.setTitle(JOptionPane.showInputDialog("Please enter the title of any film: "));
            film3.setDirector(JOptionPane.showInputDialog("Please enter the director of the chosen film"));
           film3.setDuration(Integer.parseInt(JOptionPane.showInputDialog("Please enter the running time for your chosen film")));


            catalog[i] = new Film(film3.getTitle(),film3.getDirector(),film3.getDuration());
        }
